// flow-typed signature: b85b0abdcac27eb59bcca784ed703409
// flow-typed version: <<STUB>>/seamless-immutable_v^7.1.4/flow_v0.118.0
...
declare module 'seamless-immutable' {
  ...
  declare type ImmutableStatic = {
    ...
    update<T, U>(t: Immutable<T>, key: $Keys<T>, fn: (U, ...args: any) => U, ...args: any): Immutable<T>,
    updateIn<T, U>(t: Immutable<T>, keys: Array<$Keys<T>>, fn: (U, ...args: any) => U, ...args: any): Immutable<T>,
